...
export const ALERT_TAXONOMY: Record<AlertType, AlertTaxonomyEntry> = {
  ...
  aggressive_driving: entry({ id: 'aggressive_driving', label: 'Conduite agressive (Accélération ou freinage brusque)', category: 'driving_quality', subcategory: 'Comportement', defaultSeverity: 'warning', businessImpact: 'medium', recommendedAction: 'Session de coaching', autoResolvable: false, requiresAcknowledgement: true, notificationChannels: ['in_app', 'email'] }),
  engine_overspeed: entry({ id: 'engine_overspeed', label: 'Sur-régime du moteur', category: 'driving_quality', subcategory: 'Moteur', defaultSeverity: 'warning', businessImpact: 'medium', recommendedAction: 'Réduire le régime moteur', autoResolvable: false, requiresAcknowledgement: true, notificationChannels: ['in_app'], drivingOnly: true }),
  ...
  battery_disconnected: entry({ id: 'battery_disconnected', label: 'Batterie GPS débranchée', category: 'security', subcategory: 'Protection', defaultSeverity: 'critical', businessImpact: 'high', recommendedAction: 'Risque de vol — intervention', autoResolvable: false, requiresAcknowledgement: true, notificationChannels: ['in_app', 'sms'] }),
