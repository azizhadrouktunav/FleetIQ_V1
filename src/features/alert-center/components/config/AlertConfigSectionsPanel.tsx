...
import { SeverityNotificationPanel } from './SeverityNotificationPanel';
...
export function AlertConfigSectionsPanel({ selectedScopes, vehicles }: AlertConfigSectionsPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex border-b border-slate-200 dark:border-slate-700 px-4 pt-3 gap-4">
        <button
          type="button"
